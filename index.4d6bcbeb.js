...
var _pixabayApi = require("./java/pixabay-api");
var _renderFunctions = require("./java/render-functions");
...
function searchImg(event) {
    ...
    if (!query) {
        (0, _izitoastDefault.default).warning({
    ...
    (0, _renderFunctions.clearGallery)();
    form.reset();
    loader.hidden = false;
    (0, _pixabayApi.fetchImg)(query).then((data)=>{
        if (data.hits.length === 0) {
            (0, _izitoastDefault.default).error({
                message: 'Sorry, there are no images matching your search query. Please try again!',
                position: 'topRight'
            });
            return;
        }
        (0, _renderFunctions.createGallery)(data.hits);
        let lightbox = new (0, _simplelightboxDefault.default)('.gallery-link', {
            captionsData: 'alt',
            captionDelay: 250
        });
        lightbox.refresh();
...
},{"izitoast":"ftHqY","izitoast/dist/css/iziToast.min.css":"1MVRB","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./java/pixabay-api":"5I2BB","./java/render-functions":"3rHcD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ftHqY":[function(require,module,exports,__globalThis) {
var global = arguments[3];
/*
* iziToast | v1.4.0
...
},{}],"1MVRB":[function() {},{}],"9ydBq":[function(require,module,exports,__globalThis) {
/*!
...
},{}],"kaxSc":[function() {},{}],"5I2BB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"3rHcD":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createGallery", ()=>createGallery);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["h4jLA","gLLPy"], "gLLPy", "parcelRequire94c2")
